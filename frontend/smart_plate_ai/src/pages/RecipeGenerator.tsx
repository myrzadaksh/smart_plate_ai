...
const RecipeGenerator = () => {
    ...
    const [cookingTime, setCookingTime] = useState<string>('medium');
                    ...
                    <div>
                        {generatedRecipe ? (
                            <div className="bg-white rounded-xl border border-gray-200 p-6 space-y-6">
                                    ...
                                    <ul className="space-y-2">
                                        {generatedRecipe.ingredients?.map((ing, index) => (
                                            <li key={index} className="flex items-center gap-2 text-gray-700">
                                                ...
                                                {ing.quantity > 0 && <span>{ing.quantity}</span>} {ing.unit} {ing.name}
                                            </li>
                                        ))}
                                    </ul>
                                </div>
                                ...
                                {generatedRecipe.nutrition && Object.keys(generatedRecipe.nutrition).length > 0 && (
                                    <div>
                                        <h3 className="font-semibold text-gray-900 mb-3">Nutrition (per serving)</h3>
                                        <div className="grid grid-cols-2 sm:grid-cols-5 gap-4">
                                            <NutritionBadge label="Calories" value={generatedRecipe.nutrition.calories || 0} unit="kcal" />
                                            <NutritionBadge label="Protein" value={generatedRecipe.nutrition.protein || 0} unit="g" />
                                            <NutritionBadge label="Carbs" value={generatedRecipe.nutrition.carbs || 0} unit="g" />
                                            <NutritionBadge label="Fats" value={generatedRecipe.nutrition.fats || 0} unit="g" />
                                            <NutritionBadge label="Fiber" value={generatedRecipe.nutrition.fiber || 0} unit="g" />
                                        </div>
                                    </div>
                                )}
                            ...
                            <div className="bg-white rounded-xl border border-gray-200 p-12 text-center h-full flex flex-col items-center justify-center min-h-[400px]">
