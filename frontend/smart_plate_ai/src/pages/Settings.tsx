...
const Settings = () => {
    ...
    const fetchUserData = async () => {
        try {
            ...
            const userPrefs = response.data?.data?.preferences;
                        ...
                        <form onSubmit={handleProfileUpdate} className="space-y-4">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    value={profile.email}
                                    disabled
                                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 outline-none bg-gray-50 cursor-not-allowed text-gray-500"
                                />
